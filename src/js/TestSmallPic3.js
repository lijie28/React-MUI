...
const picUrl1 = 'https://lj28.s3.ap-northeast-1.amazonaws.com/small1.jpg'
...
export class TestSmallPic3 extends React.Component {
    ...
    nextPage = () => {
        ...
        this.props.data.small_3 = { 'v': this.state.value, 't': time };
                ...
                < div className='mainArea' >
                    <div className='subArea'>
                        ...
                        <p className='mainText'>
                            Does photo below feature a face that belongs to the target person?
                        </p>
                        <Grid container
                            direction="row"
                            justifyContent="center"
