...
export class TestBigPic1 extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            value: null
    ...
    nextPage = () => {
        ...
        this.props.data.big_1 = { 'v': this.state.value, 't': time };
                ...
                < div className='mainArea' >
                    <div className='subArea'>
                        <p className='mainText'>
                            This photo looks like a selfie or features a person taking selfie.
                        </p>
